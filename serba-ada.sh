...
::   :::       :::    :::: ::  :: ::::   ::   ::  
 :   : :       :::   :: :  :    : : :   ::    :   
                                                  ";
echo "";
figlet RECEH HEHEHE | lolcat

echo -b " CODED 1M4NU3L-T4R0R3H $green " |lolcat
echo -b " FIND ME ON FB : ImanuelTaroreh $green " |lolcat
...
echo -e $b "10. SINI KALO BERANI${enda}";

echo -e $b "11. Exit${enda}";
echo -e "╭─1M4NU3L-T4R0R3H [PILIH AJA NOMERNYA]" | lolcat
read -p "╰─#" pil;

case $pil in
    1) echo "1M4NU3L TOOLS-BOT KUBIK" | lolcat
            pkg install php
...
;;
    ...
    2) echo "1M4NU3L TOOLS-VEEU" | lolcat
    		pkg install php
    		pkg install git
...
;;
 ...
 3) echo "1M4NU3L TOOLS-CAPING" | lolcat
    		pkg install php
    		pkg install git
    		...
    		;;
  4) echo "1M4NU3L TOOLS-TOTO NEWS" | lolcat
    		pkg install php
    		pkg install git
...
5) echo "1M4NU3L TOOLS-BOT BTC" | lolcat
    		pkg install php
    		pkg install git
...
6) echo "1M4NU3L TOOLS-CASHTREE" | lolcat
    		pkg install php
    		pkg install git
  ...
  7) echo "1M4NU3L TOOLS-PP GUARD" | lolcat
    		pkg install php
    		pkg install git
    		...
    		;;
8) echo "1M4NU3L TOOLS-bot pivot" | lolcat
    		pkg install php
    		pkg install git
    		...
    		9) echo "1M4NU3L TOOLS-JADWAL SHOLAT" | lolcat
    		pkg install php
    		pkg install git
...
10) echo "1M4NU3L TOOLS-GELUD KUYY" | lolcat
    		pkg install php
    		pkg install git
